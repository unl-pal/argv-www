...
public class Chart_i2 {
	...
	public void Start_100000742_exec() {
		if (TopLevel_Chart_i2_e[(1)] < 0 && TopLevel_Chart_i2_Firefct2 < 0
				|| TopLevel_Chart_i2_e[(1)] > 0 && TopLevel_Chart_i2_Coastfct2 > 0) {
			Start_100000742_exit();
			Fire_region_2_100000748_enter(0, CHART_I20);
		} else if (TopLevel_Chart_i2_e[(1)] > 0 && TopLevel_Chart_i2_Coastfct2 >= 0 && TopLevel_Chart_i2_Firefct1 < 0) {
			Start_100000742_exit();
			Coast_region_2_100000744_enter(0, CHART_I20);
		} else if (TopLevel_Chart_i2_e[(1)] > 0 && TopLevel_Chart_i2_Firefct1 > 0
				|| TopLevel_Chart_i2_e[(1)] < 0 && TopLevel_Chart_i2_Coastfct1 < 0) {
			Start_100000742_exit();
			Fire_region_1_100000743_enter(0, CHART_I20);
		} else if (TopLevel_Chart_i2_e[(1)] < 0 && TopLevel_Chart_i2_Coastfct1 <= 0 && TopLevel_Chart_i2_Firefct2 > 0) {
			Start_100000742_exit();
	...
	public void Fire_region_1_100000743_exec() {
		if (TopLevel_Chart_i2_e[(1)] < 0 && TopLevel_Chart_i2_Coastfct1 <= 0) {
			Fire_region_1_100000743_exit();
			Coast_region_1_100000747_enter(0, CHART_I20);
		} else if (TopLevel_Chart_i2_ton < (2) * TopLevel_Chart_i2_delt) {
	...
	public void Coast_region_2_100000744_exec() {
		if (TopLevel_Chart_i2_e[(1)] > 0 && TopLevel_Chart_i2_Firefct1 > 0) {
			Coast_region_2_100000744_exit();
			Fire_region_1_100000743_enter(0, CHART_I20);
		}
	...
	public void Fire_region_2_100000748_exec() {
		if (TopLevel_Chart_i2_ton < (2) * TopLevel_Chart_i2_delt) {
			TopLevel_Chart_i2_enable = 1;
			if (TopLevel_Chart_i2_ton > TopLevel_Chart_i2_tmin) {
				TopLevel_Chart_i2_count = 2;
				Fire_region_2_100000748_exit();
		...
		} else if (TopLevel_Chart_i2_e[(1)] > 0 && TopLevel_Chart_i2_Coastfct2 > 0) {
			Fire_region_2_100000748_exit();
			Coast_region_2_100000744_enter(0, CHART_I20);
		}
	...
	public void Main(double Nofjets_, double[] e_, double Firefct1_, double Coastfct1_, double Firefct2_,
			double Coastfct2_, double tjcalc1_, double tjcalc_, double[] jets_, double[] enable_, double[] ton_) {
		{
	...
	public void Init() {
		...
		execute_at_initialization_2468 = (0);
