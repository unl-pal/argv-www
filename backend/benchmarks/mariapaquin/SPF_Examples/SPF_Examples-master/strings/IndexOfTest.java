...
public class IndexOfTest {
	...
	public static void test2(String s) {
		// if (s.indexOf("" + s.charAt(2)) > 0) { // constraint generation ignores
		// charAt
		// if (s.indexOf(s + s.charAt(2)) > 0) { // constraint generation fails with
		// exception:
		if (s.indexOf(s.charAt(2)) > 0) { // constraint generation fails
											// java.lang.ClassCastException:
											// gov.nasa.jpf.symbc.string.SymbolicCharAtInteger cannot be cast to
