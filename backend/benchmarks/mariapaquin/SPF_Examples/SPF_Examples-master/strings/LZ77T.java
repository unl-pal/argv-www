...
public class LZ77T {
	...
	public static byte[] unCompress(final byte[] in) throws IOException {
		...
		final Reader mIn = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(in)));
	...
	public static byte[] compress(final byte[] in) throws IOException {
		...
		final Reader mIn = new BufferedReader(reader);
		final ByteArrayOutputStream oStream = new ByteArrayOutputStream();
		final OutputStreamWriter writer = new OutputStreamWriter(oStream);
		final PrintWriter mOut = new PrintWriter(new BufferedWriter(writer));
		String currentMatch = "";
		int matchIndex = 0;
		int tempIndex = 0;
		int nextChar;
