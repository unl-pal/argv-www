...
public class Conflict {
	...
	public static double snippet(double psi1, double vA, double vC, double xC0, double yC0, double psiC,
			double bank_ang) {
		String PATH = "";
		double dmin = 999;
		double dmst = 2;
	...
	public static void main(String[] args) {
		...
		// double cpA0_1_bankAng = SymbolicRealVars.getSymbolicReal(0.0, 50.0,
		// "cpA0_1_bankAng");

		// if ((aV > 0.0) && (cpA0_1_bankAng > 0.0)) {
		// double minsep_sec_result = snippet(aPsi, aV, c1V, c1X, c1Y, c1Psi,
		// cpA0_1_bankAng);
