...
//			masslessForce.setTo(x,y);
		...
		public static final void init(int dt) {
			...
			timeStep = rand.nextInt();

			damping = rand.nextInt();
		}
...
//		}
		...
		public static final Object getFirstParticle() {
			return new Object();
		}
...
//		}
		 ...
		 */						
		public static final Object getAllConstraints() {
			return new Object();
		}	
