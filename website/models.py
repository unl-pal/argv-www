...
class Profile(models.Model):
    ...
    token = models.CharField(max_length=40, default='', validators=[validate_gh_token], help_text=mark_safe('Be sure to first <a href="https://github.com/settings/tokens/new" target="_blank">generate a GitHub personal access token</a> and <b>check public_repo</b>.'))
