...
urlpatterns = [
    ...
    path('transform/detail/<slug>/', views.transformer_detail, name='transformer_detail'),
    path('transform/delete/<slug>/', views.delete_transformer, name='delete_transformer'),
    path('transform/download/<slug>/', views.download_transformed, name='download_transformed'),
