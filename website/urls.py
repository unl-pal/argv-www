...
urlpatterns = [
    ...
    path('password/reset/', auth_views.PasswordResetView.as_view(template_name='website/reset/passwordReset.html'), name='password_reset'),
    ...
    path('password/reset/confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='website/reset/passwordResetConfirm.html'), name='password_reset_confirm'),
